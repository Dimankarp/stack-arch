...
micro_program = [
    ...
    [mPCJump(0, True, ResStatus.Z, False)],
    # NEW COMMANDS ADDED HERE UNTIL JMPZ:
    # LESS
    [DPSignal.DSPop, ALUOp(lambda dp: dp._DS.data() - dp._TOS)],
    [mPCJump(44, False, ResStatus.N, False)],
    [mPCJump(45, False, ResStatus.V, False)],
    [ALUOp(lambda dp: 0), TOSLatch.ALU],
    [mPCJump(0, True, ResStatus.Z, False)],
    [mPCJump(42, False, ResStatus.V, False)],
    [ALUOp(lambda dp: 1), TOSLatch.ALU],
    [mPCJump(0, True, ResStatus.Z, False)],
    # GREATEQ
    [DPSignal.DSPop, ALUOp(lambda dp: dp._DS.data() - dp._TOS)],
    [mPCJump(52, False, ResStatus.N, False)],
    [mPCJump(53, False, ResStatus.V, True)],
    [ALUOp(lambda dp: 0), TOSLatch.ALU],
    [mPCJump(0, True, ResStatus.Z, False)],
    [mPCJump(50, False, ResStatus.V, True)],
    [ALUOp(lambda dp: 1), TOSLatch.ALU],
    [mPCJump(0, True, ResStatus.Z, False)],
    # JMPZ
    [ALUOp(lambda dp: dp._TOS), DPSignal.DSPop, TOSLatch.DS],
    [mPCJump(58, False, ResStatus.Z, False)],
    # JMP
    [PCLatch.IR],
    [mPCJump(0, True, ResStatus.Z, False)],
    # STASH
    ...
    [mPCJump(73, False, ResStatus.Z, False)],
